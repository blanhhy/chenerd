export const I18N = {
        zh: {
          ...
          title: "ER 图生成器",
          subtitle: "多种语法，一键绘制 Chen 氏 ER 图",
          ...
          hideFields: "隐藏属性",
          editorPlaceholder: "在此处输入 ER 图语法...（支持ER-Simple/DBML/SQL）\n\nER-Simple 示例：\nentity 学生 { *学号, 姓名, 年龄 }\nentity 课程 { *课程号, 课程名, 学分 }\nentity 选课 { *学号, *课程号, 成绩 }\n学生 1--选修--n 课程",
          btnGenerate: "⚡ 生成 ER 图",
          btnGenerateShort: "⚡ 生成",
          btnExport: "📥 导出 SVG",
          btnExportPNG: "📥 导出 PNG",
...
教师 1--讲授--n 课程`
        ...
        en: {
          ...
          subtitle:
            "Multiple Syntaxes, One-Click Chen ER Diagram Generation",
          ...
          pageTitle: "ER Diagram Generator",
          cardInputTitle: "ER 语法",
          cardPreviewTitle: "ER Preview",
          showComment: "Show comments",
          hideFields: "Hide attributes",
          editorPlaceholder: "Enter ER diagram syntax... (support ER-Simple, DBML, SQL)\n\nExample for ER-Simple:\nentity Student { *ID, Name, Age }\nentity Course { *CourseID, Name, Credit }\nentity Enrollment { *StudentID, *CourseID, Grade }\nStudent 1--Enroll--n Course",
